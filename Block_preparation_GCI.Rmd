...
The blocks were constructed by PLINK according confidence interval (Gabriel et al, 2002)
...
block_data_chr1 <- read.delim("blocks_chr1.blocks", header = FALSE, comment.char = "", stringsAsFactors = FALSE)
dim(block_data_chr1) #2853 blocks
...
```{r}
# Read the PLINK .block file into R without a header
block_data_chr2 <- read.delim("blocks_chr2.blocks", header = FALSE, comment.char = "", stringsAsFactors = FALSE)
dim(block_data_chr2) #2213
...
tail(block_data_str_filt_chr1) # chr1 block ended at block 2853
...
```{r}
# Read the PLINK .block file into R without a header
block_data_chr3 <- read.delim("blocks_chr3.blocks", header = FALSE, comment.char = "", stringsAsFactors = FALSE)
dim(block_data_chr3) #2097
...
tail(block_data_str_filt_chr2) # chr2 block ended at block 5066
#then add that to the next chromosome block as continuation of blocks partitioning
...
```{r}
# Read the PLINK .block file into R without a header
block_data_chr4 <- read.delim("blocks_chr4.blocks", header = FALSE, comment.char = "", stringsAsFactors = FALSE)
dim(block_data_chr4) #1690
...
tail(block_data_str_filt_chr3) # chr3 block ended at block 7163
#then add that to the next chromosome block as continuation of blocks partitioning
...
```{r}
# Read the PLINK .block file into R without a header
block_data_chr5 <- read.delim("blocks_chr5.blocks", header = FALSE, comment.char = "", stringsAsFactors = FALSE)
dim(block_data_chr5) #2165
...
tail(block_data_str_filt_chr4) # chr4 block ended at block 8853
#then add that to the next chromosome block as continuation of blocks partitioning
...
```{r}
# Read the PLINK .block file into R without a header
block_data_chr6 <- read.delim("blocks_chr6.blocks", header = FALSE, comment.char = "", stringsAsFactors = FALSE)
dim(block_data_chr6) #1457
...
tail(block_data_str_filt_chr5) # chr5 block ended at block 11018
#then add that to the next chromosome block as continuation of blocks partitioning
...
```{r}
# Read the PLINK .block file into R without a header
block_data_chr7 <- read.delim("blocks_chr7.blocks", header = FALSE, comment.char = "", stringsAsFactors = FALSE)
dim(block_data_chr7) #1558
...
tail(block_data_str_filt_chr6) # chr6 block ended at block 12475
#then add that to the next chromosome block as continuation of blocks partitioning
...
```{r}
# Read the PLINK .block file into R without a header
block_data_chr8 <- read.delim("blocks_chr8.blocks", header = FALSE, comment.char = "", stringsAsFactors = FALSE)
dim(block_data_chr8) #1544
...
tail(block_data_str_filt_chr7) # chr7 block ended at block 14033
#then add that to the next chromosome block as continuation of blocks partitioning
...
```{r}
# Read the PLINK .block file into R without a header
block_data_chr9 <- read.delim("blocks_chr9.blocks", header = FALSE, comment.char = "", stringsAsFactors = FALSE)
dim(block_data_chr9) #1395 
...
tail(block_data_str_filt_chr8) # chr8 block ended at block 15577
#then add that to the next chromosome block as continuation of blocks partitioning
...
```{r}
# Read the PLINK .block file into R without a header
block_data_chr10 <- read.delim("blocks_chr10.blocks", header = FALSE, comment.char = "", stringsAsFactors = FALSE)
dim(block_data_chr10) #1311 
...
tail(block_data_str_filt_chr9) # chr9 block ended at block 16972
#then add that to the next chromosome block as continuation of blocks partitioning
...
```{r}
write.table(combined_blocks_chr1_10, file = "all_chr_haplo_block_hapvwr.txt", sep = "\t", quote = FALSE, row.names = FALSE)
```
